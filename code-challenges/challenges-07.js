...
const objLat = (obj) => {
  ...
  let fName1 = obj.firstName[0].toUpperCase();
  let fName2 = obj.firstName.slice(1);
  let fName = fName1 + fName2;
  let lName1 = obj.lastName[0].toUpperCase();
  let lName2 = obj.lastName.slice(1);
  let lName = lName1 + lName2;
